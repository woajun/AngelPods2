...
<% if(request.getAttribute("Valid-write") == null){ %>
	<jsp:forward page = "l_write_view.do"/>
<% } %>
...
<!-- 분실물 등록 -->
<form action = "l_write_action.do" method = "post" enctype="multipart/form-data">
  ...
  <div class="form-control" >
    <div class="row justify-content-center">
      <div class="col-lg-6">
        ...
        <div class="col-12 mt-1">
          <input id="addrDetail" type="text" name="addrDetail" class="form-control" placeholder="상세장소"value="${param.addrDetail}" required/>
        </div>
