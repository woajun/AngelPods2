...
<div id="userBox" class="container">
  <form action = "my_modify.do" method = "post" enctype="multipart/form-data">
    <div class="row">
      ...
      <h3 class="fs-5 mt-4"><strong>${mDto.name}</strong> 님의 페이지</h3>
          ...
          <div class="col-12 mb-2">
              <button type="submit" class="btn btn-outline-secondary d-grid shadow-sm border wid100">수정</button>
          </div>
          <div class="col-12 mb-2">
