...
<title>Insert title here</title>
 ...
 <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top px-3" >
   ...
   <!-- 습득 게시물 등록 -->
   <form id="mForm" action = "f_modify.do" method = "post" enctype="multipart/form-data">
     <input name="fbNum" type="hidden" value="${dto.fbNum}">
                   ...
                   <c:forEach items="${fImages}" var = "fImages" varStatus="status">
                     <li class="imgli position-relative me-2">
                       <label for="${status.index}">
                         <img src="${pageContext.request.contextPath}/images/findBoard/${fImages.imageSystemName}" class="rounded">
                         <input type="file" id="${status.index}" accept=".jpg, .jpeg, .png" value="${fImages.imageSystemName}/${fImages.imageName}">
                       </label>
